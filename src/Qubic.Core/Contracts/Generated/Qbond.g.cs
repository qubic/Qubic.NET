...
public readonly struct GetOrdersOrder
{
    ...
    {
        Owner.AsSpan(0, 32).CopyTo(dest.Slice(0));
        BinaryPrimitives.WriteInt64LittleEndian(dest.Slice(32), Epoch);
        BinaryPrimitives.WriteInt64LittleEndian(dest.Slice(40), NumberOfMBonds);
        BinaryPrimitives.WriteInt64LittleEndian(dest.Slice(48), Price);
    }
}
...
public readonly struct GetMBondsTableTableEntry
{
    ...
    public void WriteTo(Span<byte> dest)
    {
        BinaryPrimitives.WriteInt64LittleEndian(dest.Slice(0), Epoch);
        BinaryPrimitives.WriteInt64LittleEndian(dest.Slice(8), TotalStakedQBond);
        BinaryPrimitives.WriteInt64LittleEndian(dest.Slice(16), TotalStakedQEarn);
        BinaryPrimitives.WriteUInt64LittleEndian(dest.Slice(24), Apy);
    }
}
...
public readonly struct GetUserMBondsMBondEntity
{
    ...
    public void WriteTo(Span<byte> dest)
    {
        ...
        BinaryPrimitives.WriteUInt64LittleEndian(dest.Slice(16), Apy);
    }
}
